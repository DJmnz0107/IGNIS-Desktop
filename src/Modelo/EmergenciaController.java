...
public class EmergenciaController {
   ...
   public void checkForNewEmergencies() {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        if (!emergenciasMostradas.contains(idEmergencia)) {
                            ...
                            // Llamar al método de la instancia de `frmNotificacionEmergencia`
                            vistaNotificacion.initfrmNotificacionEmergencia(descripcion, gravedad, tipo);
        ...
        }, 0, 5000); // Ejecutar cada 5 segundos
    }
