 ...
 * @author User
 */
public class btnNegroForms extends JButton {
    ...
    public btnNegroForms() {
        // Colores ajustados para fondo negro y texto blanco
        fillOriginal = Color.BLACK;
        fillOver = new Color(0x333333); // Negro más claro al pasar el mouse
        fillClick = new Color(0x111111); // Negro aún más claro al hacer clic
