 ...
 * @author aless
 */
public class TextFieldBlancoHint extends JTextField {

    private String hint;

    public TextFieldBlancoHint() {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2.fill(new RoundRectangle2D.Double(0, 0, getWidth(), getHeight(), 10, 10)); // Fondo redondeado
