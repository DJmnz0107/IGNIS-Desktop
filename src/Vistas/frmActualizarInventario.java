 ...
 * @author Diego
 */
public class frmActualizarInventario extends javax.swing.JFrame {
     ...
     */
    public frmActualizarInventario(Recursos recurso) {         
        ...
        this.recurso = recurso;
            ...
            if (recurso == null) {
        System.out.println("El objeto recurso es null");
    } else {
        System.out.println("El recurso tiene los siguientes datos: ");
        System.out.println("Nombre: " + recurso.getNombreRecurso());
        System.out.println("Descripción: " + recurso.getDescripcionRecurso());
    ...
    public static void initfrmActualizarInventario(Recursos recurso) {
        FlatRobotoFont.install();
        FlatLaf.registerCustomDefaultsSource("vistas.themes");
        UIManager.put("defaultFont", new Font(FlatRobotoFont.FAMILY,Font.PLAIN,13));
        FlatLightLaf.setup();
        Recursos modelo = new Recursos();
        frmActualizarInventario vista = new frmActualizarInventario(recurso);
        ctrlActualizarInventario controlador = new ctrlActualizarInventario(modelo, vista);
    ...
    return new ImageIcon(imagenEscalada);
       ...
       private  void cargarDatos() {
        txtNombreInventario.setText(recurso.getNombreRecurso());
        txtDescripcionRecurso.setText(recurso.getDescripcionRecurso());
        dtcRecepcion.setDate(recurso.getFechaRecepcionRecurso());
        cmbDisponibilidad.setSelectedItem(recurso.getDisponibilidadRecurso());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Registro inventario > Actualizar inventario");
        ...
        btnActualizar.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 14)); // NOI18N
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 590, 220, 50));
        ...
        jPanel1.add(imgInventario, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 340, 340, 230));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmActualizarInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
