 ...
 * @author angel
 */
public class frmRegistroAspirantes extends javax.swing.JFrame {

    /**
     * Creates new form frmRegistroAspirantes
     */
    public frmRegistroAspirantes() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRegistroAspirantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRegistroAspirantes().setVisible(true);
            }
        });
    }
